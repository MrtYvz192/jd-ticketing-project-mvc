...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(RoleServiceImpl roleService, UserServiceImpl userService, ProjectServiceImpl projectService, TaskServiceImpl taskService) {
    ...
    public void run(String... args) throws Exception {
        ...
        UserDTO user1 = new UserDTO("John", "Kesy",
                "john@cybertek.com", "abc", true, "7459684532", managerRole, Gender.MALE);
        ...
        UserDTO user4 = new UserDTO("Shaun",
                "Hayns", "S001@cybertek.com", "123", true, "3256987412", managerRole, Gender.MALE);
        ...
        ProjectDTO project2 = new ProjectDTO("Spring ORM","PR002",user2,LocalDate.now(), LocalDate.now().plusDays(10),"Creating Controllers", Status.IN_PROGRESS);
        ProjectDTO project3 = new ProjectDTO("Spring Container","PR003",user4,LocalDate.now(), LocalDate.now().plusDays(32),"Creating Controllers", Status.UAT_TEST);
